...
class ServiceStub(service: MediaService ): IMediaAidlInterface.Stub()  {

    val mService:  WeakReference<MediaService> = WeakReference(service)

    override fun isPlaying(): Boolean {

        var isPlaying =  mService.get()?.isPlaying
    ...
    override fun playOnLine(songId: Long) {

        mService.get()?.playOnLine(songId)
    }
}